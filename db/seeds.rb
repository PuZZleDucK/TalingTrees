...
Tree.create!(name: 'Silver Maple', treedb_com_id: '124', treedb_common_name: 'Maple', treedb_genus: 'Acer', treedb_family: 'Sapindaceae', treedb_diameter: '25', treedb_date_planted: '2019-06-15', treedb_age_description: 'Mature', treedb_useful_life_expectency_value: '60', treedb_precinct: 'North', treedb_located_in: 'Street', treedb_uploaddate: '2024-01-02', treedb_lat: -37.8140, treedb_long: 144.9640, llm_model: 'Qwen3:latest', llm_sustem_prompt: 'Describe the tree')

Tree.create!(name: 'Radiata Pine', treedb_com_id: '125', treedb_common_name: 'Pine', treedb_genus: 'Pinus', treedb_family: 'Pinaceae', treedb_diameter: '40', treedb_date_planted: '2015-03-10', treedb_age_description: 'Mature', treedb_useful_life_expectency_value: '70', treedb_precinct: 'East', treedb_located_in: 'Reserve', treedb_uploaddate: '2024-01-03', treedb_lat: -37.8150, treedb_long: 144.9650, llm_model: 'Qwen3:latest', llm_sustem_prompt: 'Describe the tree')

Tree.create!(name: 'River Red Gum', treedb_com_id: '126', treedb_common_name: 'Eucalyptus', treedb_genus: 'Eucalyptus', treedb_family: 'Myrtaceae', treedb_diameter: '35', treedb_date_planted: '2018-11-20', treedb_age_description: 'Mature', treedb_useful_life_expectency_value: '80', treedb_precinct: 'West', treedb_located_in: 'Park', treedb_uploaddate: '2024-01-04', treedb_lat: -37.8160, treedb_long: 144.9660, llm_model: 'Qwen3:latest', llm_sustem_prompt: 'Describe the tree')
