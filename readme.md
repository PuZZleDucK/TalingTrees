...
[ ] when naming trees we should use lat/long data to lookup suburb and relative location in it
[ ] when naming trees we should use lat/long data to lookup nearby landmarks
[ ] when naming trees we should use lat/long data to lookup nearby streets
